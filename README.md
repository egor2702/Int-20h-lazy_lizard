...
Tags: #coding #misc  [[ML]] 
## Test Case
**Description**: Identify a set of events and parameters with the highes or lowest correlation with the potential account cancellation. Prioritize the events, event properties or user properties, which have highest or lowest correlation with the account cancellation.

### Task Breakdown
- [x] perform EDA [completion:: 2023-02-07]
- [x] feature engineering [completion:: 2023-02-07]
- [ ] write readme + table of compared features
___
## Related Notes
# INT20H lazy_lizard
